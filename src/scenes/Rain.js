class Rain extends Phaser.Scene {
    ...
    create() {
        ...
        this.anims.create({
            key: 'waterRain',
            frames: this.anims.generateFrameNumbers('waterRain', {start: 0, end: 11, first: 0}), frameRate: 3
        });
        ...
        //place spritesheets
        this.background = this.add.tileSprite(0, 0, gamewidth, gameheight, 'bgRain').setOrigin(0, 0);
        this.trees = this.add.tileSprite(0, 0, gamewidth, gameheight, 'treesRain').setOrigin(0, 0);
        this.clouds = this.add.tileSprite(0, 0, gamewidth, gameheight, 'cloudsRain').setOrigin(0, 0);        
